...
class ArchipelagoManager
{
  private:
	...
	// State tracking
	std::vector<APItem> _receivedItems;
	...
	// Item mappings
	std::map<std::string, int64_t> _itemToLocationMap;
	std::map<int64_t, APItemInfo> _receivedItemMap;
  ...
  public:
	...
	const std::vector<APItem> &getReceivedItems() const;
  ...
  private:
	...
	/// Get research name from item ID
	const APItemInfo* getItemById(int64_t itemId) const;
